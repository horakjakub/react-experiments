...
export const SearchVideoChannelContext: Context<SearchVideoChannelContext> = React.createContext(
  defaultValue,
);
...
export const SearchVideoChannelContextProvider = ({
  ...
  const [state, setState] = useState<SearchVideoChannelState>({phrase: ''});
